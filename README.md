...
`wget https://raw.githubusercontent.com/dennis-tsvetkov/openvpn-install/refs/heads/master/openvpn-install.sh -O openvpn-install.sh && bash openvpn-install.sh`
